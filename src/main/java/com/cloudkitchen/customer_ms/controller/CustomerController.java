...
import com.cloudkitchen.customer_ms.service.CustomerService;
...
public class CustomerController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Customer> updateCustomer(@PathVariable Long id, @RequestBody Customer updatedData) {
